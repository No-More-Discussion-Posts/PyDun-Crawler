...
class Collision(System):
    ...
    def update(self):
        for entity in self.entities:
            ...
            if pygame.sprite.spritecollide(entity.game.player, entity.game.blocks, False):
            ...
            elif pygame.sprite.spritecollide(entity.game.player, entity.game.monsters, False):
                entity.game.state = GameStates.BATTLE
            
            elif pygame.sprite.spritecollide(entity.game.player, entity.game.doors, False):
